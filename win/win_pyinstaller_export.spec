...
a = Analysis([src_path+'main_data\\main.py'],
             pathex=[output_path],
             datas=[],
             hiddenimports=['matplotlib','pandas','seaborn','pygam','pingouin','PyQt5.sip','scipy._lib.messagestream', 'PyQt5.QtQuickWidgets','matplotlib.backends.backend_pdf','matplotlib.backends.backend_svg'],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
